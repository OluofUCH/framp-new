      ...
      {step === 1 && (
        <div className="max-w-sm mx-auto min-h-screen flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 pt-6">
            ...
            <span className="text-lg font-medium">On-Ramp</span>
                ...
                <div className={`${cardClasses} bg-[#C2C0EB]  rounded-3xl p-6 border shadow-sm`}>
                  ...
                  <div className="mb-0">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[purple-100] dark:bg-purple-900/30 rounded-full">
                      <span className={`${isDarkMode ? 'text-white' : 'text-black'} text-sm font-medium`}>On-Ramp</span>
                    </div>
                  </div>
                  ...
                  {/* You Pay Section */}
                  <div className={`mb-[-15px] ${isDarkMode ? 'bg-gray-900' : 'bg-[#E3E2F5]'} rounded-lg px-4 py-2`}>
